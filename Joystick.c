...
void EVENT_USB_Device_ControlRequest(void)
{
	...
	case HID_REQ_GetReport:
			...
			(REQDIR_DEVICETOHOST | REQTYPE_CLASS | REQREC_INTERFACE))
		{
			...
			// We'll then populate this report with what we want to send to the
			// host.
			GetNextReport(&JoystickInputData);
			// Since this is a control endpoint, we need to clear up the SETUP
			...
			Endpoint_Write_Control_Stream_LE(&JoystickInputData,
	...
	case HID_REQ_SetReport:
			...
			(REQDIR_HOSTTODEVICE | REQTYPE_CLASS | REQREC_INTERFACE))
		{
			...
			Endpoint_Read_Control_Stream_LE(&JoystickOutputData,
...
void HID_Task(void)
{
	...
	if (Endpoint_IsINReady())
	{
		...
		Endpoint_Write_Stream_LE(&JoystickInputData, sizeof(JoystickInputData),
								 NULL);
		// We then send an IN packet on this endpoint.
		Endpoint_ClearIN();
